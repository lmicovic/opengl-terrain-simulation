...
out vec3 normals;
out vec3 toLightVector[NumberOfLights];					// Vector From Sufrace Normal to Light
out vec3 toCameraVector;								// Vector From Vertex to the Camera

// Fog
out float visibility;
float density = 0.005;			// Gustina Magle
float gradient = 1.6;			// Gradient Magle koliko brzo prelazi iz viljivog u Maglu
//----------------------------------
