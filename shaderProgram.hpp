...
public:
    ...
    void bindAttribute(int attribute, char* varriableNam) {
        glBindAttribLocation(this->ID, attribute, varriableNam);
    }
    ...
    void loadBoolean(int location, int boolean) {
        if(boolean == 0 || boolean == 1) {
            glUniform1f(location, boolean);
        } else {
            std::cout << "Error boolean number must be in range 0 - 1.";
            exit(1);
        }
    }

    void loadMatrix(int location, const glm::mat4 &mat) const {
